...
function Messages() {
  ...
  return (
    <>
      <div
        key={`${chatId}header`}
        className="chatbox-header dark:bg-tahiti-300 dark:text-white text-black shadow-lg dark:shadow-none flex items-center"
      >
        <div className="sm:hidden flex-none">
          <button
            className="p-2 text-blue-800 dark:text-white"
            onClick={() =>
      ...
      <div
        key={`${chatId}body`}
        className="chatbox-body dark:bg-tahiti-300 pr-3 pl-3 lg:pt-5 overflow-y-auto flex-1 shadow-lg "
      >
        {user &&
      ...
      <div
        key={`${chatId}textarea`}
        className="flex py-3 px-1 dark:bg-tahiti-300"
      >
